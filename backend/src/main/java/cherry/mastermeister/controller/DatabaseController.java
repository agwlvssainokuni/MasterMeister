...
public class DatabaseController {
    ...
    public ApiResponse<DatabaseConnectionResponse> getConnection(
        ...
        return ApiResponse.success(toResponse(connection));
    }
    ...
    public ApiResponse<DatabaseConnectionResponse> createConnection(
        ...
        return ApiResponse.success(toResponse(savedConnection));
    }
    ...
    public ApiResponse<DatabaseConnectionResponse> updateConnection(
        ...
        return ApiResponse.success(toResponse(updatedConnection));
    }
    ...
    private DatabaseConnectionResponse toResponse(DatabaseConnection model) {
